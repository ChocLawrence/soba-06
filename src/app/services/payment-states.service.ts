...
export class PaymentStatesService {
  ...
  addPaymentState(dataObject: any): Promise<any> {
    let url = this.apiUrl;
  ...
  /** PUT: update a currenciess basic data  */
  updatePaymentState(dataObject: any, id: any): Promise<any> {
    let url = this.apiUrl + '/' + id;
  ...
  deletePaymentState(id: any): Promise<any> {
    let url = '';
